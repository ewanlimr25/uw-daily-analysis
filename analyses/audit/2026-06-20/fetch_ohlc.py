...
chart API carries real high/low. This pulls OHLC so Phase 2 can run the true
daily-bar path-aware resolution. Window covers ATR(14) lookback before the earliest
entry (2026-05-25) through the last available bar (2026-06-18).
"""
import urllib.request, json, ssl, datetime, calendar, time, os, sys

OUT = "analyses/audit/2026-06-20/_ohlc"
...
P1, P2 = epoch("2026-04-15"), epoch("2026-06-20")
...
def main():
    tb = json.load(open("analyses/audit/2026-06-20/_tickers.json"))
    ...
    json.dump(manifest, open("analyses/audit/2026-06-20/_ohlc_manifest.json", "w"), indent=0)
