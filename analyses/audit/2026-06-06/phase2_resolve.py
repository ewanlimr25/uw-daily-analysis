...
WEEK_FRIDAY = {"2026-W18": "2026-05-01", "2026-W19": "2026-05-08",
               ...
               "2026-W22": "2026-05-29", "2026-W23": "2026-06-05"}
...
def main():
    ...
    for r in rows:
        ...
        # carry the interim mark-to-market (window_open_mtm) instead. Earliest LEAP entry
        # (2026-04-30) has 25 forward trading days by the 2026-06-05 last bar — still <30,
        # so all LEAPs remain window_open (verified this run).
