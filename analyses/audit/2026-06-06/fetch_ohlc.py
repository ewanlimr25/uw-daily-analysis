...
OUT = "analyses/audit/2026-06-06/_ohlc"
...
# 2026-06-06 captures the last available bar (2026-06-05).
P1, P2 = epoch("2026-03-01"), epoch("2026-06-06")
...
def main():
    tb = json.load(open("analyses/audit/2026-06-06/_tickers.json"))
    ...
    json.dump(manifest, open("analyses/audit/2026-06-06/_ohlc_manifest.json", "w"), indent=0)
