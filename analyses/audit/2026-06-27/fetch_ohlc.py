...
entry (2026-05-25) through the last available bar (~2026-06-26).
"""
...
P1, P2 = epoch("2026-04-15"), epoch("2026-06-30")
...
def main():
    ...
    for i, s in enumerate(syms):
        ...
        if os.path.exists(path):
            ...
            if d.get("ok") and d.get("bars") and d["bars"][-1]["date"] >= "2026-06-24":
