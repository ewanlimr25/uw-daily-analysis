...
1. `uw hot-chains sweep-persistence` — **PRIMARY**. Rank tickers by persistence count (≥3 of last 5 days same direction). This is the alpha. Everything else is supporting evidence.
